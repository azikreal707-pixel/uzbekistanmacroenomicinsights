        ...
        [
            html.Div(
                [
                    ...
                    dcc.Graph(id="line-chart", style={"height": "60vh", "width": "100%"}),
                    html.Div(
                        [
            ...
            html.Div(
                [
                    ...
                    dcc.Graph(id="region-area-chart", style={"height": "60vh", "width": "100%"}),
                    html.Div(
                        [
                            html.Div(
                                [
...
def update_line_chart(year_range):
    ...
    fig = px.line(
        ...
        color="Metric",
        markers=True,
        labels={"Value": "Amount", "Year": "Year", "Metric": "Type"},
    )
    fig.update_layout(
        title_x=0.5,
        plot_bgcolor="white",
